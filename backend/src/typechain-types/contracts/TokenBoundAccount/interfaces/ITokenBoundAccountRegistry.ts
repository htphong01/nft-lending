...
export interface ITokenBoundAccountRegistryInterface extends Interface {
...
export interface ITokenBoundAccountRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): ITokenBoundAccountRegistry;
  waitForDeployment(): Promise<this>;

  interface: ITokenBoundAccountRegistryInterface;
