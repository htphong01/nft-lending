export const WXCRS_ABI = [
  ...
  },
  {
    ...
    inputs: [{ type: 'address', name: 'account', internalType: 'address', indexed: true }],
    anonymous: false,
  },
  {
    type: 'event',
  ...
  },
  {
    ...
    inputs: [
      ...
      { type: 'uint256', name: '_discountFactor', internalType: 'uint256' },
    ],
  },
  {
    type: 'function',
  ...
  },
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{ type: 'address', name: '', internalType: 'contract ILendingPool' }],
    name: 'lendingPool',
    inputs: [],
  },
  {
  ...
  { type: 'function', stateMutability: 'nonpayable', outputs: [], name: 'registerLendingPool', inputs: [] },
