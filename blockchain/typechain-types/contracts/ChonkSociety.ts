...
export interface ChonkSocietyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ChonkSociety extends BaseContract {
  connect(runner?: ContractRunner | null): ChonkSociety;
  waitForDeployment(): Promise<this>;

  interface: ChonkSocietyInterface;
