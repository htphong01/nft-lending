...
export interface WXENEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  getEvent(
    nameOrSignatureOrTopic: "Approval" | "Burnt" | "Minted" | "Transfer"
  ): EventFragment;
...
export interface WXENE extends BaseContract {
  connect(runner?: ContractRunner | null): WXENE;
  waitForDeployment(): Promise<this>;

  interface: WXENEInterface;
  ...
  mintTo: TypedContractMethod<[_receiver: AddressLike], [void], "payable">;
