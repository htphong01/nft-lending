...
export interface ITokenBoundAccountInterface extends Interface {
  getFunction(
...
export interface ITokenBoundAccount extends BaseContract {
  connect(runner?: ContractRunner | null): ITokenBoundAccount;
  waitForDeployment(): Promise<this>;

  interface: ITokenBoundAccountInterface;
