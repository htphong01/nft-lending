...
export interface DirectLoanBaseMinimal extends BaseContract {
  connect(runner?: ContractRunner | null): DirectLoanBaseMinimal;
  waitForDeployment(): Promise<this>;

  interface: DirectLoanBaseMinimalInterface;
